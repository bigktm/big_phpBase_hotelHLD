...
if (isset($_REQUEST['themphong'])){
	...
	if($result) {
		header("location:admin.php?option=hangtrung");
	}
}
...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-laptop"></i> Phòng hạng trung</h3>
		<ol class="breadcrumb">
			<li><i class="fa fa-home"></i><a href="admin.php">Trang chủ</a></li>
			<li><i class="fa fa-laptop"></i>Phòng hạng trung</li>						  	
		</ol>
	</div>
</div>
<div class="row">
												...
												if ($row_dm['id'] == $phongId){
													...
													<td class='text-center'>
														<select name='chonstatus' class='form-control'>";
															...
															<td class='text-center'>
																<div class='btn-group'>
																	<a class='btn btn-success' href='admin.php?option=hangtrung&suaphong={$row_dm['id']}'><i class='icon_pencil-edit'></i></a>
																	<a class='btn btn-danger' href='admin.php?option=hangtrung&xoaphong={$row_dm['id']}'><i class='icon_close_alt2'></i></a>
																</div></td>
															</tr>";
														}
														$i++;
